...
func (a *App) buildUI() fyne.CanvasObject {
	...
	statusBar := BGBox(colorBgSecondary, container.NewHBox(a.statusLabel))
...
func (a *App) buildFileListPanel() fyne.CanvasObject {
	...
	return container.NewBorder(BGBox(colorBgTertiary, header), nil, nil, nil, scroll)
}
...
func (a *App) buildEditTab() fyne.CanvasObject {
	...
	return container.NewBorder(nil, BGBox(colorBgSecondary, btnBar), nil, nil, a.detailTable)
}
...
func (a *App) buildSimTabFull() fyne.CanvasObject {
	...
	configArea := container.NewVBox(
		BGBox(colorBgSecondary, filterRow),
		BGBox(colorBgSecondary, paramRow),
	)
	...
	summaryBar := BGBox(colorBgSecondary, container.NewBorder(nil, nil, nil, exportBtn, a.simResultLabel))
...
func (a *App) buildAuthTab() fyne.CanvasObject {
	...
	cardActivate := BGBox(colorBgCard,
		container.NewPadded(container.NewVBox(
